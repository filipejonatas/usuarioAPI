...
export default function HomePage() {
  ...
  const navigateToUserManagement = () => {
    if (canManageUsers) {
      ...
      alert('Acesso negado. Apenas administradores e gerentes podem acessar esta página.')
    }
  }
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            {/* User Management Card (Admin or Manager) */}
            {canManageUsers && (
              <div className="bg-white overflow-hidden shadow rounded-lg">
                <div className="p-5">
                  <div className="flex items-center">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <Shield className={`h-6 w-6 ${isAdmin ? 'text-green-400' : user?.role === 'Manager' ? 'text-purple-400' : 'text-yellow-400'}`} />
                  </div>
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">
                      ...
                      <dd className="text-sm text-gray-500">
                        {isAdmin 
                          ...
                          : user?.role === 'Manager'
                          ? 'Pode visualizar e criar usuários'
          ...
          <div className="mt-8 bg-white shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="text-sm text-gray-600 space-y-2">
                ...
                <p>• Administradores e gerentes podem acessar o gerenciamento de usuários</p>
